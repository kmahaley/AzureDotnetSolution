...
namespace AzureConsoleApplication
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            TokenRequestContext con = new TokenRequestContext(new[] { "https://graph.microsoft.com/.default" } );
            var token = credential.GetToken(con);
            var t = token.Token;
            //VisualStudioCredential credential = new ClientSecretCredential(tenantId, clientId, clientSecret);
